...
// WiFi
const char* ssid = "CRNS";                
const char* wifi_password = "Crns#2020#";

// MQTT
const char* mqtt_server = "10.1.40.64"; 
const char* humidity_topic = "humidity";
const char* temperature_topic = "temperature";
const char* mqtt_username = "thermostat"; // MQTT username
const char* mqtt_password = "thermostat"; // MQTT password
